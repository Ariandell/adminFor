  ...
  return (
    <div>
      ...
      {showForm && <Card tone="accent" className="mb-5"><form onSubmit={save} className="space-y-4">
        ...
        {duplicate && <div className="rounded-xl bg-butter-100 border border-butter-200 p-3 text-sm text-butter-700"><strong>Схожа картка вже є:</strong> {duplicate.original_word} — {duplicate.translation} · {duplicate.level || 'A1'}<span className="block mt-1 text-xs">Її все одно можна зберегти для іншого контексту.</span></div>}
